...
export default function ModalAddStatus({ openAdd, handleClose, setOpenAdd }: Props) {
    ...
    <div>
      ...
      >
        <Box sx={style}>
          ...
          <div className='mt-5'>
            {/* <label>Nome</label> */}
            <TextField id="standard-basic" label="Nome do Status" variant="standard" onChange={e => setNome(e.target.value)} sx={{ width: '16rem' }} />
          </div>
